...
add_filter(
	...
	function ( $exporters ) {
		$exporters['belstroj-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'belstroj-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'belstroj-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'belstroj-leads',
						'group_label' => __( 'Quote requests', 'belstroj-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['belstroj-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'belstroj-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
