...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'belstroj-leads' ),
				'storm'       => __( 'Storm or hail damage', 'belstroj-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'belstroj-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'belstroj-leads' ),
				'not-sure'    => __( 'Vet inte än', 'belstroj-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'belstroj-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'belstroj-leads' ),
				'research' => __( 'Jag kollar bara priser', 'belstroj-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'belstroj-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'belstroj-leads' ),
		'contacted' => __( 'Kontaktad', 'belstroj-leads' ),
		'quoted'    => __( 'Quote sent', 'belstroj-leads' ),
		'won'       => __( 'Won', 'belstroj-leads' ),
		'lost'      => __( 'Lost', 'belstroj-leads' ),
		'spam'      => __( 'Misstänkt spam', 'belstroj-leads' ),
	);
}
